...
type CheckpointService interface {
	...
	// Update changes code, display_name, column_name, and distance_from_start; returns domain.ErrLocked if race order is locked.
	Update(ctx context.Context, id int, code, displayName string, columnName *string, distance *float64) (entity.Checkpoint, error)
