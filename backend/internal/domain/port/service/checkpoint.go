...
type CheckpointService interface {
	...
	// Update changes code, display_name, column_name, distance_from_start, and cutoff_time; returns domain.ErrLocked if race order is locked.
	Update(ctx context.Context, id int, code, displayName string, columnName *string, distance *float64, cutoffTime *string) (entity.Checkpoint, error)
