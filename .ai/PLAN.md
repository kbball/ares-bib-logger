...
### 1. Correct a mis-logged bib (Admin → Edit Runners)
...
### 2. Add single runner to roster (late race addition)
...
### 3. Overall stats card on Data Entry tab
...
### 4. Split pace between aid stations on runner detail modal
